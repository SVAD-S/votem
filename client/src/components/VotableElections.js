        ...
        <>
          {election[1] === true && election[2] === false ? (
            ...
            >
              ...
              <Link to={`/vote/${election[0]}`} className="title">
                <button className="flex-no-shrink p-2 text-sm ml-2 border-2 rounded text-green-500 border-green-500 hover:text-white hover:bg-green-400">
                  Go Voting
                </button>
              </Link>
            </div>
...
export default VotableElections;
